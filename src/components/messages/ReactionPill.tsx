  ...
  return (
    <button
      ...
      className={[
        ...
        active
          ? "border-[#1164a3] bg-[rgba(17,100,163,0.2)] text-[#d1d2d3]"
          : "border-[#3f4144] bg-[#2c2d30] text-[#ababad] hover:border-[#1164a3] hover:bg-[rgba(17,100,163,0.1)]",
      ].join(" ")}
    >
  ...
  return (
    <EmojiPicker onSelect={onSelect}>
      <button
        ...
        className="inline-flex h-[26px] items-center rounded-full border border-[#3f4144] bg-[#2c2d30] px-2 text-[#ababad] transition-colors duration-150 hover:border-[#1164a3] hover:bg-[rgba(17,100,163,0.1)] hover:text-white"
      >
        <Plus size={13} />
      </button>
    </EmojiPicker>
